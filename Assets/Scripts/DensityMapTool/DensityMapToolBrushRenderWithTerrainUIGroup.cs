...
public class DensityMapToolBrushRenderWithTerrainUIGroup : IBrushRenderWithTerrain
{
    ...
    public DensityMapToolBrushRenderWithTerrainUIGroup(IBrushUIGroup uiGroup, string name, Texture brushTexture)
    {
        m_UiGroup = uiGroup;
        m_Name = name;
...
public class DensityMapToolBrushRenderPreviewWithTerrainUiGroup : DensityMapToolBrushRenderWithTerrainUIGroup, IBrushRenderPreviewWithTerrain
{
    public DensityMapToolBrushRenderPreviewWithTerrainUiGroup(IBrushUIGroup uiGroup, string name, Texture brushTexture) : base(uiGroup, name, brushTexture)
    {
    }
