...
public abstract class DensityMapToolBrushRenderPreviewUnderCursor<TBase> : IBrushRenderUnderCursor where TBase : DensityMapToolBrushRenderWithTerrainUIGroup
{
    ...
    protected DensityMapToolBrushRenderPreviewUnderCursor(IBrushUIGroup uiGroup, string name, Texture brushTexture)
    {
...
public class DensityMapToolBrushRenderPreviewUIGroupUnderCursor : DensityMapToolBrushRenderPreviewUnderCursor<DensityMapToolBrushRenderPreviewWithTerrainUiGroup>, IBrushRenderPreviewUnderCursor
{
    public DensityMapToolBrushRenderPreviewUIGroupUnderCursor(IBrushUIGroup uiGroup, string name, Texture brushTexture) : base(uiGroup, name, brushTexture)
    {
    }
